...
public class EntryBuilderTest {
	...
	public void entryBuilder_noteEntryWithNoteAsSubEntry_subEntryShouldBeNoteEntry()
		...
		Assert.assertTrue(Note.class.isInstance(noteEntry.getSubEntries()
				.get(0).getContent()));
	}

	@Test
	public void entryBuilder_noteEntryWithTaskAsSubEntry_subEntryShouldBeTaskEntry()
			throws Exception {
		...
		// System.out.println(noteEntry);
		Assert.assertTrue(Task.class.isInstance(noteEntry.getSubEntries()
				.get(0).getContent()));
	}
